...
//#else
//#warning WavePropagationBlock_1D should only be used with Riemann solvers (FWave, AugRie or Hybrid)
//#endif

namespace Blocks {

  /**
   * Blocks::WavePropagationBlock_1D is an implementation of the Blocks::Block abstract class.
...
//#endif
  ...
  public:
    /**
     * Constructor of a Blocks::WavePropagationBlock_1D.
     *
